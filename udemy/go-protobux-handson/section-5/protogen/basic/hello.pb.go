...
const file_proto_basic_hello_proto_rawDesc = "" +
	"\n" +
	"\x17proto/basic/hello.proto\"\x1b\n" +
	"\x05Hello\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04nameB\x10Z\x0eprotogen/basicb\x06proto3"

var (
	file_proto_basic_hello_proto_rawDescOnce sync.Once
	file_proto_basic_hello_proto_rawDescData []byte
)

func file_proto_basic_hello_proto_rawDescGZIP() []byte {
	file_proto_basic_hello_proto_rawDescOnce.Do(func() {
		file_proto_basic_hello_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_basic_hello_proto_rawDesc), len(file_proto_basic_hello_proto_rawDesc)))
	})
...
func file_proto_basic_hello_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_basic_hello_proto_rawDesc), len(file_proto_basic_hello_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
